 ...
 */
public class DatePickerFragment_Insurance extends DialogFragment {
    ...
    public static DatePickerFragment_Insurance newInstance(Context context, AddCarActivity.DateDialogFragmentListener listener, Calendar now) {
        DatePickerFragment_Insurance dialog = new DatePickerFragment_Insurance();
